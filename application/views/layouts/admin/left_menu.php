...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="content_type"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/content_type/index'); ?>"><i class="icon_table"></i>Content type</a></li>
        <li <?php if($this->router->fetch_class()=="content_manage"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/content_manage/index'); ?>"><i class="icon_table"></i>Content</a></li>
        <li <?php if($this->router->fetch_class()=="members"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/members/index'); ?>"><i class="icon_table"></i>Members</a></li>
        <li <?php if($this->router->fetch_class()=="gallery"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/gallery/index'); ?>"><i class="icon_table"></i>Home Page Gallery(Slide)</a></li>
        <li <?php if($this->router->fetch_class()=="file_management"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/file_management/index'); ?>"><i class="icon_table"></i>File management</a></li>
        <li <?php if($this->router->fetch_class()=="text_scroll"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/text_scroll/index'); ?>"><i class="icon_table"></i>Text Scroll</a></li>
